...
file = 'edt2_20210401_1800.txt'
# file = '46000-2021040206.edt'

p, T, Td, ws, wd = np.loadtxt(file, skiprows = 6, usecols = (3, 4, 6, 8, 7), unpack = True)
# p, T, RH, ws, wd = np.loadtxt(file, skiprows = 3, usecols = (2, 3, 4, 5, 6), unpack = True)
lat, lon = np.loadtxt(file, skiprows = 6, usecols = (10, 11), unpack = True)
...
skew.ax.set_title(f'Sounding   Time: {file[5:9]}/' + f'{file[9:11]}/' + f'{file[11:13]} ' + f'{file[14:16]}Z', loc = 'left', va = 'bottom', fontsize = 26.)
...
# Show the plot
plt.savefig(f'skewT_{file[5:18]}.png', dpi = 300)
plt.show()
